        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                ...
                if (cacheHandler.requestHandler.extendTtl) {
                    ...
                    VidiunLogger.setRequestSessionId(request, cacheHandler.cacheKey + ":" + request.sessionId);
                ...
                // handling aggregation type request - extending ttl if exists in cache.
                    ...
                    VidiunLogger.setRequestSessionId(request, roundedCacheKey + ":" + request.sessionId);
