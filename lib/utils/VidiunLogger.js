...
VidiunLogger = {
	...
	access: function(request, response){
		...
		request.log = function(msg){
			VidiunLogger.log('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
		request.dir = function(object){
			VidiunLogger.dir(object, getStack(), 'Worker [' + request.workerId + '] Request [' + request.sessionId + '] ');
		};
		request.error = function(msg){
			VidiunLogger.error('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
		request.debug = function(msg){
			VidiunLogger.debug('Worker [' + request.workerId + '] Request [' + request.sessionId + '] ' + msg, getStack());
		};
